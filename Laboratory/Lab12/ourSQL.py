...
if __name__ == "__main__":
    path = "Laboratory/Lab12/ourDB.db"
    ...
    query = queryStatement("Owner.Name,Animal.Name", "Owner,Animal", "Owner.AnimalID == Animal.ID and Animal.Age<=3 ") # TODO: Fill this in
    for x in theCursor.execute(query):
        print(x)
    ...
    query = queryStatement("Count(distinct Vet.VetID)",
